...
/// <summary>
/// Requirecomponent agrega al game object donde incluyes este script, los componentes que escribas dentro
/// </summary>
...
public class MovementController : NetworkBehaviour
{
    ...
    private void Movement(NetworkInputData input)
    {
        ...
        // cambiamos rbplayer.linearvelocity por kcc
        // como modificaba linearvelocity, ahora modifica kinematicvelocity, ya que kcc es kinematico
