...
{
    // este valor networked nos ayudara en rotate camera
    ...
    /// <summary>
    /// Fixed update es para cambios de logica
    /// </summary>
    ...
    {
        if(!HasInputAuthority && !HasStateAuthority) // cualquier jugador que no seas tu
        {
    ...
    private void RotateCamera(NetworkInputData input)
    {
        ...
        // aqui definimos el valor de camVelocity.y
        ...
        // Mi calculo de rotacion se hace local, pero mi rotacion va a verse en el network
        camY = camVelociy.y;
